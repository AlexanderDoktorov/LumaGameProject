...
public:
	...
	//PL : Zadaniem funckji jest dodanie przesuniкcia wzglкdem punktu celu, tak aby wyeliminowaж kolizjк wzglкdemi innych kontrolerуw AI.Moїe siк zdaїyж taka sytuacja їe kilka kotrolerуw bкdzie doїyж do jednego punktu.Ta funkcja stara siк wyeliminowaж tak№ sytuacjк.
